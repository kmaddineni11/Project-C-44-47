...
function draw(){
  ...
  if(gameState === START){
    textSize(17);
    text("Press Space To Start The Game", displayWidth/2 - 100, displayHeight/4);
  ...
  if(gameState === PLAY && player.y === 370){
    ...
    textSize(17);
    text("Game Over!",  displayWidth/2 - 70, displayHeight/4 - 40)
    text("Press R To Try Again!",  displayWidth/2 - 100, displayHeight/4)
